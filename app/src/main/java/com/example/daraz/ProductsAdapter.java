...
class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.MyViewHolder>{
    Context context;
    List <Product_daraz> Productss;

    public ProductsAdapter(Context context, List<Product_daraz> Productss) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_splash_recyclerview,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final Product_daraz Products = Productss.get(position);
